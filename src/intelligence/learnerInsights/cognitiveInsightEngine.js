...
export function deriveInsights(learnerState, attempts = [], mistakes = {}) {
  ...
  // 3. Hidden Strength Pattern
  // High accuracy (>= 80%) but low self-reported confidence ('guess' or 'unsure')
  ...
  // 4. Knowledge Decay Risk
  // Based on estimated retention scores
