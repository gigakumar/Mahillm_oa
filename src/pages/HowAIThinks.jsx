  ...
  return (
    <div className="page-content" style={{ padding: '2rem', maxWidth: '1000px', margin: '0 auto', color: '#fff' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        ...
        {/* Student Model */}
        <div style={{ background: 'var(--bg-elevated)', padding: '1.5rem', borderRadius: '12px', borderLeft: '4px solid #3b82f6', display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
        ...
        <div style={{ background: 'var(--bg-elevated)', padding: '1.5rem', borderRadius: '12px', borderLeft: '4px solid #8b5cf6', display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
        ...
        <div style={{ background: 'var(--bg-elevated)', padding: '1.5rem', borderRadius: '12px', borderLeft: '4px solid #ec4899', display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
        ...
        {/* Decision Engine */}
        <div style={{ background: 'var(--bg-elevated)', padding: '1.5rem', borderRadius: '12px', borderLeft: '4px solid #10b981', display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
